<p align="center">
  <img src="https://img.shields.io/badge/bookstack--cli-BookStack%20API-blue?style=for-the-badge" alt="bookstack-cli">
</p>

<h1 align="center">bookstack-cli</h1>
...
<p align="center">
  <a href="https://pypi.org/project/bookstack-cli/"><img src="https://img.shields.io/pypi/v/bookstack-cli?style=flat-square&logo=pypi&logoColor=white" alt="PyPI Version"></a>
  <a href="https://pypi.org/project/bookstack-cli/"><img src="https://img.shields.io/pypi/pyversions/bookstack-cli?style=flat-square&logo=python&logoColor=white" alt="Python Versions"></a>
...
**bookstack-cli** is a Python package for working with the [BookStack REST API](https://demo.bookstackapp.com/api/docs) from scripts or the command line. It provides a small typed client, environment-based configuration, JSON output, and parallel batch reads.
